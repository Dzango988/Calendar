...
class App : Application() {
    ...
    private fun seedHolidaysIfNeeded() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val holidays = listOf(
                ImportantDate(title = "Новый год", day = 1, month = 1,
                    category = DateCategory.HOLIDAY, colorHex = "#FFD93D",
                    description = "С Новым годом! 🎄"),
                ImportantDate(title = "Рождество", day = 7, month = 1,
                    category = DateCategory.HOLIDAY, colorHex = "#FFD93D",
                    description = "Православное Рождество"),
                ImportantDate(title = "День защитника Отечества", day = 23, month = 2,
                    category = DateCategory.HOLIDAY, colorHex = "#4D96FF",
                    description = "23 февраля 🎖️"),
                ImportantDate(title = "Международный женский день", day = 8, month = 3,
                    category = DateCategory.HOLIDAY, colorHex = "#EC4899",
                    description = "8 марта 🌹"),
                ImportantDate(title = "День труда", day = 1, month = 5,
                    category = DateCategory.HOLIDAY, colorHex = "#6BCB77",
                    description = "Праздник весны и труда"),
                ImportantDate(title = "День Победы", day = 9, month = 5,
                    category = DateCategory.HOLIDAY, colorHex = "#FF6B6B",
                    description = "9 мая 🎖️"),
                ImportantDate(title = "День России", day = 12, month = 6,
                    category = DateCategory.HOLIDAY, colorHex = "#4D96FF",
                    description = "С Днём России! 🇷🇺"),
                ImportantDate(title = "День народного единства", day = 4, month = 11,
                    category = DateCategory.HOLIDAY, colorHex = "#FF8E53",
                    description = "4 ноября"),
                ImportantDate(title = "День Конституции", day = 12, month = 12,
                    category = DateCategory.HOLIDAY, colorHex = "#4D96FF",
                    description = "12 декабря"),
                ImportantDate(title = "Международный день детей", day = 1, month = 6,
                    category = DateCategory.HOLIDAY, colorHex = "#FFD93D",
                    description = "1 июня 🎈"),
                ImportantDate(title = "День Святого Валентина", day = 14, month = 2,
                    category = DateCategory.HOLIDAY, colorHex = "#EC4899",
                    description = "14 февраля ❤️"),
                ImportantDate(title = "Хэллоуин", day = 31, month = 10,
                    category = DateCategory.HOLIDAY, colorHex = "#FF8E53",
